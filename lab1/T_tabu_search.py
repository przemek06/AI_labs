...
def T_tabu_search(graph, start_stop, stops_to_visit, start_time, optimization_criterion):
    ...
    while i < SIMPLE_TABU_SEARCH_ITERATION_LIMIT:
        ...
        viable = [item for item in neighbourhood if item not in tabu]
